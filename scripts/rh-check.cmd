...
cargo test --locked --test rh_aot_smoke --test rh_aot_ci_policy --test rh_regression --test rh_backend --test rh_corpus --test rh_framed_worker --test rh_cli_forward --test rh_standalone_cli --test script_check_many --test performance_experiment_policy
if errorlevel 1 exit /b 1
