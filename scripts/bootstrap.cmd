...
set "AGENTERM_BOOTSTRAP_RH_CLI=%AGENTERM_BOOTSTRAP_DIR%\agenterm-rh.exe"
if not exist "%AGENTERM_BOOTSTRAP_RH_CLI%" set "AGENTERM_BOOTSTRAP_RH_CLI="
...
set "AGENTERM_RHAI_COMPAT_CLI=%AGENTERM_BOOTSTRAP_WORKER%"
set "AGENTERM_BOOTSTRAP_TASK_CLI=%AGENTERM_BOOTSTRAP_WORKER%"
if defined AGENTERM_BOOTSTRAP_RH_CLI set "AGENTERM_BOOTSTRAP_TASK_CLI=%AGENTERM_BOOTSTRAP_RH_CLI%"

"%AGENTERM_BOOTSTRAP_TASK_CLI%" task run "%AGENTERM_BOOTSTRAP_TASK%" --manifest "%AGENTERM_BOOTSTRAP_REPO%\agenterm.tasks.json" -- %*
if errorlevel 1 goto :failed
call :cleanup
popd
exit /b 0
...
:cleanup
if defined AGENTERM_BOOTSTRAP_RH_CLI del /q "%AGENTERM_BOOTSTRAP_RH_CLI%" >nul 2>nul
