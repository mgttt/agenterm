...
The low 16 bits encode `slot + 1`; the high 16 bits encode its generation.
...
old token. One table supports at most 65,535 live slots and may choose a much
smaller product-specific bound.
...
was authorized. Separate native-module namespaces should use separate tables.
...
- permanent retirement after all 65,535 generations rather than aliasing;
