...
- AgenTerm
  ...
  - [Lightweight specialized intelligence (`agenterm-ai.exe`)](prd/PRD_02_12_specialized_intelligence.md) — Benchmark-gated rules, classic ML, and small sequence workers.
  - [Local LLM gateway (`agenterm-llm-gateway.exe`)](prd/PRD_02_13_llm_gateway.md) — Governed forwarding, routing, quota, audit, and credential isolation.
  ...
  - [Focused super-fleet roadmap](prd/PRD_02_18_roadmap.md) — Version ownership, milestone gates, and future product lanes.
