...
| 35 | [`agenterm-tinyvm` WASM 1.0 interpreter](prd/PRD_02_35_agenterm_tinyvm.md) | iOS 边界下的自有 native WASM 核，非 H5/JS/WKWebView；`eval(bytes)→` 值或错；WASM 1.0 全部 172 条 MVP 操作码；核 <100KiB |
