...
- [~] `agenterm-con` evolves as a single-GUI-process, lightweight terminal
  ...
  host; its x86_64 release PE is currently 563,200 bytes versus 1,046,528 bytes
