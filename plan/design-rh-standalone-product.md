...
| Git-pin precedent | `../wbox/Cargo.toml` (**sibling repo** `/Users/cbzw032/repos/wbox`, not a member of this workspace): `agenterm-platform = { git = "https://github.com/mgttt/agenterm.git", rev = "c8ace42", default-features = false }` — **public** repo `mgttt/agenterm` (not `partnernetsoftware/agenterm`), full SHA, feature-gated |
