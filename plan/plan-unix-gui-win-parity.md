...
├─ D3 [~] Win remote vs Unix embedded 共享交互管线（selection phase、focus 导航、wheel 累积/路由、raw-mouse 仲裁与 scrollbar thumb drag 已收为 crate 共享；modal/focus 进入规则已收为 `FocusState` 共享模型）
