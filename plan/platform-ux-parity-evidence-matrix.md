...
|---|---|---|---|---|---|
| selection gesture | `src/frontend/selection.rs` | `SelectionGesturePhase` / `RemoteSelectionGesture` 单份定义；Windows remote 与 Unix 共用产品选区状态机，adapter 只映射原生事件 | Supported | Supported | Supported |
