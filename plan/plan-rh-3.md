...
| **日期** | 2026-08-06 |
| **状态** | **M42 推进中；M42d1–d4（字符串、动态 fail、MapSet、path/metadata）已完成，import bundling 待做** |
...
| M42d | 补齐 import bundling，无损迁移 `validate-artifact-manifest`；不得用 substring 或任务专用宿主校验器替代脚本不变量 | [ ] |
