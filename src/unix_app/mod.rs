...
use layout::{
    ...
    scrollbar_hit_test, sidebar_width_u32, terminal_cell_at, terminal_pixel_rect, wheel_delta_units,
        ...
        render_frame(
            ...
            FrameContent {
                ...
                terminal: TerminalPaint {
                    grid,
                    selection: self.terminal_selection.filter(|selection| {
                        self.active == Some(selection.tab_id)
                    }),
                },
