...
fn depth_well_replay_is_portable_bounded_and_tamper_evident() {
    ...
    assert_eq!(
        ...
        [
            0xee, 0x34, 0xb3, 0xe5, 0xf7, 0x9c, 0xcd, 0x8e, 0x1d, 0xf6, 0x8c, 0x49, 0xc0, 0x6a,
            0x20, 0x02, 0xd9, 0xc0, 0x5a, 0x32, 0xb4, 0xce, 0x3a, 0x3d, 0x80, 0xbb, 0x37, 0x5f,
            0x54, 0x47, 0xcd, 0x3d,
        ],
...
fn replay_cli_records_checks_reproduces_and_never_overwrites() {
    ...
    assert_eq!(
        ...
        [
            0x0a, 0x42, 0x50, 0x3b, 0x30, 0xc3, 0x51, 0x28, 0x72, 0xc7, 0x8f, 0x44, 0x08, 0x4f,
            0xbf, 0x8d, 0x68, 0x48, 0xdd, 0xce, 0x51, 0x63, 0x45, 0x69, 0x9a, 0xd9, 0x01, 0x66,
            0x4f, 0x97, 0xd1, 0x8f,
        ],
